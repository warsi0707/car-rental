...
function page() {
  return (
    ...
    //       <SignFormInput label={"Full Name"} placeholder={"Johny Depp"} type={'text'} />
    //       <SignFormInput label={"Email"} placeholder={"Johny@gmail.com"} type={'Email'}  />
    //       <SignFormInput label={"Password"} placeholder={"Password"} type={'Password'}  />
    //      <SignButton/>
    ...
    //         <p>Have an account? <Link href={"/"} className='underline '>Signin</Link></p>
    //         <p>Tearm and condition</p>
    //       </div>
    //     </div>

    //     <div className='hidden h-full w-full sm:flex justify-center items-center p-5'>
    //       <img className='h-full object-cover rounded-2xl rounded-tr-4xl w-full ' src="https://images.unsplash.com/photo-1583121274602-3e2820c69888?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />
    //     </div>
